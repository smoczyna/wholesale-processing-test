...
public class FinancialEventCategory implements Serializable {
   ...
   private String financialeventnormalsign;
    ...
    public String getFinancialcategorydescription() {
        return CassandraTableReference.stringEchoing(financialcategorydescription,
				CassandraTableReference.DEFAULT_CASSANDRA_HIDDEN_ECHO_CHARACTER);
    }

    public void setFinancialcategorydescription(String financialcategorydescription) {
        this.financialcategorydescription = CassandraTableReference.stringEchoing(financialcategorydescription,
        									CassandraTableReference.DEFAULT_CASSANDRA_HIDDEN_ECHO_CHARACTER);
    }
    ...
    public String getFinancialeventdescription() {
        return CassandraTableReference.stringEchoing(financialeventdescription,
				CassandraTableReference.DEFAULT_CASSANDRA_HIDDEN_ECHO_CHARACTER);
    }

    public void setFinancialeventdescription(String financialeventdescription) {
        this.financialeventdescription = CassandraTableReference.stringEchoing(financialeventdescription,
				CassandraTableReference.DEFAULT_CASSANDRA_HIDDEN_ECHO_CHARACTER);
    }
