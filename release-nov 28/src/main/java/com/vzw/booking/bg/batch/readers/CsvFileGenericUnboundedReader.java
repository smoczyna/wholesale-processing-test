 ...
 * @param <T>
 */
public class CsvFileGenericUnboundedReader<T> extends FlatFileItemReader<T> {

    private final Class<T> payloadClass;
    
    public CsvFileGenericUnboundedReader(Class<T> payloadClass, String filePath, String[] fieldNames, String delimiter, int linesToSkip) {
        super();
