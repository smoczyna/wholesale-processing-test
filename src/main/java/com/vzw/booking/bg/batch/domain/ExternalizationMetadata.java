...
public class ExternalizationMetadata {
	...
	public ExternalizationMetadata clone() {
		return clone(this.format);
	}
	
	public ExternalizationMetadata clone(ExternalizationFormat format) {
		ExternalizationMetadata clone = new ExternalizationMetadata(format);
		clone.metaDataList.addAll(this.metaDataList);
