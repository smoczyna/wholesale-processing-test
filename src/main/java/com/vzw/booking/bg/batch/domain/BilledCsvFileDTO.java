 ...
 * @author smorcja
 */
public class BilledCsvFileDTO implements BaseBookingInputInterface, RawType<String> {
    ...
    public Long getTollBillSeconds() {
        return tollBillSeconds;
    }

    public void setTollBillSeconds(Long tollBillSeconds) {
