...
public class WholesaleBookingProcessor<T> implements ItemProcessor<T, WholesaleProcessingOutput> {
    ...
    /**
     * this method is a main processing start point for all 3 file types
     *
     * @param inRec
     * @return
     * @throws Exception
    ...
    /**
     * creates and populates subledger output records
     * @param tmpChargeAmt
     * @param financialEventCategory
     * @param financialMarket
     * @param dbcrIndicatorFromFile
     * @return 
     */
    ...
    /**
     * creates second booking record, opposite to the original one given as parameter
     * @param subLedgerOutput - original booking record
     * @return 
     */
    ...
    /**
     * alternative booking checker determines if the records should be booked with non-standard way 
     * @param inRec - input record
     * @return 
     */
    ...
    /**
     * determines if records should be skipped from booking
     * this is not an error but regular booking logic
     * @param financialEventCategory - fin event records from cassandra
     * @param altBookingInd - alternate booking flag
     * @return 
     */
    ...
    /**
     * makes the booking what means creating 2 output records for each input record
     * that happen only when amount is greater than zero
     * @param inRec - input record
     * @param outRec - output record
     * @param iecCode - inter exchange indicator
     */
    ...
    /**
     * billed records processing logic 
     * @param billedRec
     * @return 
     */
    private WholesaleProcessingOutput processBilledRecord(BilledCsvFileDTO billedRec) {
        ...
        if (zeroAirCharge && zeroTollCharge) {
            ...
            // HERE BAD RECORD
            ChannelHelper.collectProcessError(billedRec);
            return null;
        }
    ...
    /**
     * unbilled records processing logic
     * @param unbilledRec
     * @return 
     */
    ...
    /**
     * adminfee record processing logic
     * @param adminFeesRec
     * @return 
     */
    ...
    /*
     * following 3 methods call cassandra db when necessary for additional processing data
     */
