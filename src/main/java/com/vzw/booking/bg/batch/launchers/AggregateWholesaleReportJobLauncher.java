 ...
 */
@Component
public class AggregateWholesaleReportJobLauncher {

    private static final Logger LOGGER = LoggerFactory.getLogger(AggregateWholesaleReportJobLauncher.class);
    ...
    @Autowired
    AggregateWholesaleReportJobLauncher(@Qualifier("billedBookingAggregateJob") Job job, JobLauncher jobLauncher) {
        this.job = job;
