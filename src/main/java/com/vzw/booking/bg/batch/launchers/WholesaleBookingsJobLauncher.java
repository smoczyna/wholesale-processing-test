 ...
 */
@Component
public class WholesaleBookingsJobLauncher {

    private static final Logger LOGGER = LoggerFactory.getLogger(WholesaleBookingsJobLauncher.class);
    ...
    @Autowired
    WholesaleBookingsJobLauncher(@Qualifier("billedBookingAggregateJob") Job job, JobLauncher jobLauncher) {
        this.job = job;
