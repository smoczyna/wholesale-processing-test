...
public class SubledgerCsvFileWriter extends CsvFileGenericWriter<SummarySubLedgerDTO> {
    ...
    public SubledgerCsvFileWriter(Environment environment) {        
        super(environment.getRequiredProperty(PROPERTY_CSV_EXPORT_FILE_PATH).concat(Constants.SUBLEDGER_SUMMARY_FILENAME), COLUMN_NAMES, Constants.DEFAULT_CSV_FIELDS_DELIMITER);
    }    
}
