...
public class Constants {
    ...
    public static final String BOOK_DATE_SKIPPED_ERROR_FILENAME = "error_skipped_bookdate.csv";
    public static final String FINANCIAL_EVENT_OFFSET_SKIPPED_ERROR_FILENAME = "error_skipped_offset.csv";
    public static final String BILLED_BOOKING_SKIPPED_ERROR_FILENAME = "error_skipped_billed.csv";    
    public static final String ALTERNATE_BOOKING_SKIPPED_ERROR_FILENAME = "error_skipped_altbook.csv";    
    public static final String UNBILLED_BOOKING_SKIPPED_ERROR_FILENAME = "error_skipped_unbilled.csv";
    public static final String ADMIN_FEES_SKIPPED_ERROR_FILENAME = "error_skipped_adminfees.csv";
    public static final String ADMIN_FEES_PROCESS_ERROR_FILENAME = "error_process_adminfees.csv";
    public static final String ALTERNATE_BOOKING_PROCESS_ERROR_FILENAME = "error_process_altbook.csv";    
    public static final String BILLED_BOOKING_PROCESS_ERROR_FILENAME = "error_process_billed.csv";    
    public static final String UNBILLED_BOOKING__PROCESS_ERROR_FILENAME = "error_process_unbilled.csv";
    public static final String SUBLEDGER_WRITE_ERROR_FILENAME = "error_write_subledger.csv";
    public static final String WHOLESALE_WRITE_ERROR_FILENAME = "error_write_wholesale.csv";
    ...
    public static final String TARGET_LOCATION_MISSING_MESSAGE = "Target location missing !!!";
    public static final String FILES_NOT_FOUND_MESSAGE = "Source file(s) do not exist";
    public static final String FILES_NOT_SPLITTED_MESSAGE = "Could't split Source file(s) in chunks!!!";
