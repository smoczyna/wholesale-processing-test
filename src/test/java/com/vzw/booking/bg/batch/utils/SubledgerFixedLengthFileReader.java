...
import com.vzw.booking.bg.batch.readers.CsvFileGenericUnboundedReader;

/**
 *
 * @author smorcja
 */
public class SubledgerFixedLengthFileReader extends CsvFileGenericUnboundedReader<SummarySubLedgerDTO> {
